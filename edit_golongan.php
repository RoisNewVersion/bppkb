			...
			<div class="col-lg-12">
				...
				<form action="proses_golongan.php" method="post" class="form-horizontal">
					...
					<!-- <div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="tmt_jabatan" class="form-control tgl" id="tmt_jabatan" placeholder="TMT Jabatan" value="" required="">
						</div>
					</div> -->
					<div class="form-group">
					...
					<!-- <div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="tmt_gol" class="form-control tgl" id="tmt_gol" placeholder="TMT Golongan" required="" value="">
						</div>
					</div>
					<div class="form-group">
						<label for="mk_thn" class="col-sm-2 control-label">MK Tahun</label>
						<div class="col-sm-4">
							<input type="text" name="mk_thn" class="form-control" id="mk_thn" placeholder="MK Tahun" required="" value="">
						</div>
					</div>
					<div class="form-group">
						<label for="mk_bln" class="col-sm-2 control-label">MK Bulan</label>
						<div class="col-sm-4">
							<input type="text" name="mk_bln" class="form-control" id="mk_bln" placeholder="MK Bulan" required="" value="">
						</div>
					</div> -->
					<div class="form-group">
