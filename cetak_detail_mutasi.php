...
<head>
	...
	<title>Cetak Laporan detail Mutasi</title>
...
<div id="page-content-wrapper">
	<div class="row">
		<table width="100%">
			<tr>
				...
				<td><h3 class="title-header">Data Detail Mutasi Pegawai</h3></td>
	...
	<table id="tabelku" class="table table-bordered table-hover">
                            ...
                            $mutasis = $app->con->get('tabel_mutasi m', null, 'm.id_mutasi ,m.no_surat, m.tmt_baru, k.nip, k.nama_karyawan, i.nama_ins as din_lama, i2.nama_ins as din_baru');
                            // echo '<pre>';
                            // print_r($mutasis);
                            // echo '</pre>';
                            // die();
                            foreach ($mutasis as $mutasi){ ?>
                                <tr>
                                    ...
                                    <td><?= $mutasi['din_lama'] ?></td>
                                    <td><?= $mutasi['din_baru'] ?> </td>
